'''
this code produce random data with missing invalid data 
if random().random()<0.25 this meaning that this invalid data with missing values and error input values  
produce data and send it to topic in kafka {row_factor}
'''
import json
import random
import time
